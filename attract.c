...
static const uint8 kAttract_Legendgraphics_0[157+1] __attribute__((section (".noreloc"))) = {
...
static const uint8 kAttract_Legendgraphics_1[237+1] __attribute__((section (".noreloc"))) = {
...
static const uint8 kAttract_Legendgraphics_2[199+1] __attribute__((section (".noreloc"))) = {
...
static const uint8 kAttract_Legendgraphics_3[265+1] __attribute__((section (".noreloc"))) = {
